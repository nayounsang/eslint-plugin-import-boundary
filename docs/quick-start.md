...
- Skip-level, upward, and peer imports are denied.
...
| Goal | Page |
|------|------|
| Shared helpers under an owner | [`sharedFiles`](shared-files.md) |
| Sibling / cross-root barrels | [`files`](files.md) |
| Barrel path shape | [Barrel only](barrel-only.md) |
| Why these rules exist | [Why](README.md) |
